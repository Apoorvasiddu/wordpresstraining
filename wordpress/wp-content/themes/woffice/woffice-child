		...
		<div id="content-container">
			...
			<div id="content">
				<div class="row mb-5 align-items-center">
					<div class="col-md-6">
						<?php echo '<h1 class="post-title">'.$title.'</h1>';?>
					</div>
					<div class="col-md-6 text-right">
						<?php
							...
							<?php echo'<a href="#blog-create" class="btn btn-default frontend-wrapper__toggle" data-action="display" id="show-blog-create"><i class="fa fa-plus-square"></i> '. $new_blog_button_text .'</a>';
						?>
					</div>
				</div>
