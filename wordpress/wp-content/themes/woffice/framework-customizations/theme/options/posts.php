		...
		'options' => array(
			...
			'projects-box' => array(
				...
				'options' => array(
					...
					'projects_task_review_subject'    => array(
						'label' => __('Task Review Notification Subject', 'woffice' ),
						'desc'  => __('This is the subject task request review.', 'woffice' ),
						'type'         => 'text',
						'value'        => 'Task Review Notification',
					),
					'projects_task_review_content'    => array(
						'label' => __('Task Review Notification Content', 'woffice' ),
						...
						'type'  => 'textarea',
						'value' => 'Hey {user_name},<br/> You have a new task for review.<br/> Task Title :{todo_title} <br/> in project: {project_url}',
					),
				),
			),
			'blog-box' => array(
