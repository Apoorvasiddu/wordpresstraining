		...
		'options' => array(
			...
			'project_todo_lists' => array(
			    ...
			    'box-options' => array(
					...
					'has_kanban' => array( 'type' => 'hidden'),
					'review_request' => array( 'type' => 'checkbox', 'label' => __('Request For Review', 'woffice'),'value' => FALSE),
					'todo_reviewer' => array( 'type' => 'select', 'label' => __('Select the member for review.', 'woffice'),'choices' => $tt_users_tmp,),
