...
function woffice_get_custom_css()
{
	...
	**
	...
	$color_text_para = woffice_get_settings_option('color_text_para');
	...
	if(isset($color_main_bg) && !empty($color_main_bg)){
	...
	$css .= '}';
	$css .= '#left-content, #user-sidebar, #main-content, body.is-blank-page, body.is-modern-skin, body.is-glass-skin {';
	...
	**
	...
	$menu_icon_color 	= woffice_get_settings_option('menu_icon_color');
	...
	$css .= '#navigation{background: ' . $menu_background . ';}';
	...
	// LAYOUT
	$css .= 'body.rtl.menu-is-vertical #main-content:not(.navigation-hidden), body.rtl.menu-is-vertical #main-footer:not(.navigation-hidden){ padding-right: ' . $menu_width . 'px;}';
