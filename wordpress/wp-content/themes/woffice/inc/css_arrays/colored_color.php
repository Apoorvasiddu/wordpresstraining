...
$colored_color = array(
    ...
    '.woffice-atmodal .woffice-users-suggest_reviewer-list li i',
    '.wokr-modal-wrapper a',
    '.wokr-modal-wrapper a:hover',
    '.wokr-modal-wrapper a:active',
    '.wokr-cs-table .woffice-okr-icons-color'
);