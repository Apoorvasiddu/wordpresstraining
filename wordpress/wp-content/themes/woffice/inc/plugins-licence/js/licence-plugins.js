jQuery(function () {
  var woffice_interval = setInterval(function () {
    ...
    var woffice_woae_key = jQuery('#fw-option-woffice_woae_status').val();
    var woffice_wosubscribe_key = jQuery('#fw-option-woffice_wosubscribe_key_status').val();
    var woffice_hr_bundle = jQuery('#fw-option-woffice_hr_bundle').val();
    ...
    var woffice_adreporting_key = jQuery('#fw-option-woffice_adreporting_status').val();
    var woffice_tmv_key = jQuery('#fw-option-woffice_tmv_status').val();
    var woffice_okr_key = jQuery('#fw-option-woffice_okr_status').val();
    var woffice_pm_key = jQuery('#fw-option-woffice_pm_status').val();
    var woffice_crm_key = jQuery('#fw-option-woffice_crm_status').val();
    var woffice_crm_enhancements_key = jQuery('#fw-option-woffice_crm_enhancements_status').val();
    var advanced_events_key = jQuery('#fw-option-advanced_events_status').val();
  ...
  if (woffice_okr_key) {
	...
	if (woffice_pm_key) {
		clearInterval(woffice_pm_key);
	}
  if (woffice_crm_key) {
    clearInterval(woffice_crm_key);
  }
  if (woffice_crm_enhancements_key) {
    clearInterval(woffice_crm_enhancements_key);
  }
  if (advanced_events_key) {
    clearInterval(advanced_events_key);
  }
    
    WocptActDeActButton('woffice_cpt_key');
    WocptActDeActButton('woffice_woae');
    WocptActDeActButton('woffice_wosubscribe_key');
    WocptActDeActButton('woffice_hr_bundle');
    ...
    WocptActDeActButton('woffice_adreporting');
    WocptActDeActButton('woffice_tmv');
    WocptActDeActButton('woffice_okr');
    WocptActDeActButton('woffice_pm');
    WocptActDeActButton('woffice_crm');
    WocptActDeActButton('woffice_crm_enhancements');
    WocptActDeActButton('advanced_events');
	}, 1000);
});
