        ...
        if(isset($_GET['type']) && ($_GET['type'] == 'lost-password' || $_GET['type'] == 'reset-password')) {
            if (isset($_REQUEST['errors'])) {
                ...
                foreach ($error_codes as $error_code) {
                    switch ($error_code) {
	                    case 'ldap_user_error':
		                    $message ='Ldap users are not allowed to reset password here';
		                    break;
                        case 'empty_username':
...
if (! function_exists('woffice_login_render_reset_password')) {
    ...
    function woffice_login_render_reset_password()
    {
        ...
        <div id="go-back-to-login" class="text-center login-btn-resetpassword">
            <?php // Login URL:
...
if (! function_exists('woffice_login_render_script')) {
    ...
    function woffice_login_render_script() {
        ...
        <script type="text/javascript">
            ...
            jQuery("#register-trigger").on('click', function(e){
                e.preventDefault();
                show_register();
            });
