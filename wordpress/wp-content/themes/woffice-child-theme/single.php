		...
		<div id="left-content">
			...
			<div id="content-container">
				...
				<div id="content">
				    ...
				    <!-- Back button for individual posts start -->
				    <?php
                    if (is_single()) {
                        echo '<div id="post-back-btn">';
                        echo '<i class="fas fa-chevron-left"></i> Back';
                        echo '</div>';
                    }
                    ?>
                    <!-- Back button for individual posts end -->
					...
					if (woffice_is_user_allowed()) { ?>
						...
						if ($edit_allowed || $delete_allowed) { ?>
							...
							<div class="frontend-edit-wrapper box">
